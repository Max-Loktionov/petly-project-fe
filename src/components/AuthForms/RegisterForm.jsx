...
const RegisterForm = () => {
    ...
    const { register, handleSubmit, formState: { errors, isValid }, setFocus, watch } = useForm({
        mode: 'onBlur',
    });
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)} autoComplete="on">
            ...
            {!nextPage ? <RegisterBtn type='button' onClick={handleClick} disabled={!isValid}>Next</RegisterBtn> : <RegisterBtn type='submit' disabled={isDisabled}>Register</RegisterBtn>}
            {nextPage && <BackBtn type='button' onClick={handleClickBack}>Back</BackBtn>}
        </Form>
    )
}
