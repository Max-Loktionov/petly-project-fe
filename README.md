...
улюбленців, переглядати список тварин, яких можна придбати, або шукати новини, пов'язані з життям наших менших.
...
На планшетній і мобільній версіях компонент **_Nav_**, **_UserNav_**, **_AuthNav_** відображаються в бургер меню. Логотип додатку не є
клікабельним.
...
### **6. NoticesPage** | маршрут - **_/notices/:categoryName_**
...
- **_NoticesCategoriesNav_** - блок навігації. Компонент рендерить блок навіції з маршрутами:
  ...
  - **_/notices/lost-found_** - відкриває на сторінці компонент **_NoticesCategoryList_** зі списком оголошеннь з знайшов/шукаю
  - **_/notices/for-free_** - відкриває на сторінці компонент **_NoticesCategoryList_** зі списком оголошеннь з віддам в добрі руки.
